					...
					<div className="steps__container grid">
						<div className="steps__card">
							...
							<p className="steps__card-description">
								We have several varieties plants you can choose
								from.
							</p>
						</div>
						...
						<div className="steps__card">
							...
							<p className="steps__card-description">
								Once your order is set, we move to the next step
								which is the shipping.
							</p>
						</div>
						...
						<div className="steps__card">
							...
							<p className="steps__card-description">
								Our delivery process is easy, you receive the plant
								direct to your door.
							</p>
						</div>
					</div>
